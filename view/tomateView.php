...
<br />
<div>          
	<a href="addTomateController.php" class="btn btn-primary">
	<i class="fas fa-plus"></i> Ajouter une tomate 
	</a>
</div>
...
?>
		<tr>
			<th scope="row"><?php echo $tomate->id ?></th> 
			<td><?php echo $tomate->photo ?></a></td>
            <td><?php echo $tomate->name ?></td>
            <td><?php echo $tomate->price ?> euros</td> 
			<td><?php echo $tomate->description ?></td> 
			<td><a href="updateTomateController.php?id=<?php echo $tomate->id ?>"><i class="fas fa-pencil-alt"></i></a></td>
			<td><a href="deleteTomateController.php?id=<?php echo $tomate->id ?>"><i class="fas fa-trash-alt"></i></a></td>
        </tr>
<?php 
}
?>	  			
